...
#define BABEL_DATADIR "/usr/local/Cellar/open-babel/3.0.0/share/openbabel"

/* The version of Open Babel */
#define BABEL_VERSION "3.0.0"
...
#define OB_MODULE_PATH "/usr/local/Cellar/open-babel/3.0.0/lib/openbabel/3.0.0"
